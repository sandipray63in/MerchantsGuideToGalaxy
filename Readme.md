...
10) Some .NET specific resources are like [Easy way to create a C# lambda expression from a string (with Roslyn)](https://www.strathweb.com/2018/01/easy-way-to-create-a-c-lambda-expression-from-a-string-with-roslyn/), [Parsing In C#: Tools And Libraries](https://tomassetti.me/parsing-in-csharp/) and [Dynamic compilation as a very fast mathematic
parser in .NET](http://www.naun.org/main/NAUN/mcs/2015/a082002-224.pdf).          
